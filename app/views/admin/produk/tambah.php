    ...
    <div class="card-body">
        <form action="<?= BASE_URL ?>admin/tambahProduk" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= isset($errors['nama_produk']) ? 'is-invalid' : '' ?>" id="nama_produk" name="nama_produk" value="<?= $nama_produk ?? '' ?>" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control <?= isset($errors['harga']) ? 'is-invalid' : '' ?>" id="harga" name="harga" value="<?= $harga ?? '' ?>" min="0" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control <?= isset($errors['stok']) ? 'is-invalid' : '' ?>" id="stok" name="stok" value="<?= $stok ?? '' ?>" min="0" required>
