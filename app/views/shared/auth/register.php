            ...
            <div class="card-body">
                ...
                <form action="<?= BASE_URL ?>auth/doRegister" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control <?= isset($errors['nama']) ? 'is-invalid' : '' ?>" id="nama" name="nama" value="<?= $nama ?? '' ?>" placeholder="Nama Lengkap" required>
                    ...
                    <div class="form-floating mb-4">
                        <input type="password" class="form-control <?= isset($errors['confirm_password']) ? 'is-invalid' : '' ?>" id="confirm_password" name="confirm_password" placeholder="Konfirmasi Password" required>
                    ...
                    <div class="login-link">
                        <p>Sudah punya akun? <a href="<?= BASE_URL ?>auth">Login Sekarang</a></p>
                    </div>
                </form>
            </div>
        </div>
