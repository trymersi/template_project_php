...
<head>
    ...
    <meta name="description" content="<?= APP_NAME ?> - User Dashboard">
    <meta name="author" content="<?= APP_NAME ?>">
    <link rel="icon" href="<?= BASE_URL ?>assets/images/favicon.ico">

    <title><?= $title ?? APP_NAME ?> - User</title>
...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">    
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu animated flipInX">
                            <li class="user-body">
                                <a class="dropdown-item" href="<?= BASE_URL ?>user/profil"><i class="ti-user text-muted me-2"></i> Profil</a>
    ...
    <aside class="main-sidebar">
        ...
        <div class="sidebar-footer">
            <a href="<?= BASE_URL ?>user/profil" class="link" data-bs-toggle="tooltip" title="Profil"><i class="ti-user"></i></a>
